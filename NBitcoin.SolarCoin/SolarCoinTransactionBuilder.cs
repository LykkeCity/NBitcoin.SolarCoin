...
using Builder = System.Func<NBitcoin.SolarCoin.SolarCoinTransactionBuilder.TransactionBuildingContext, NBitcoin.IMoney>;
...
namespace NBitcoin.SolarCoin
{
    ...
    /// </summary>
    public class SolarCoinTransactionBuilder
    {
        internal class SolarCoinTransactionBuilderSigner : ISigner
        {
            ICoin coin;
            SigHash sigHash;
            IndexedTxIn txIn;
            public SolarCoinTransactionBuilderSigner(ICoin coin, SigHash sigHash, IndexedTxIn txIn)
            {
                this.coin = coin;
        ...
        internal class SolarCoinTransactionKeyRepository : IKeyRepository
        {
            TransactionSigningContext _Ctx;
            SolarCoinTransactionBuilder _TxBuilder;
            public SolarCoinTransactionKeyRepository(SolarCoinTransactionBuilder txBuilder, TransactionSigningContext ctx)
            {
                _Ctx = ctx;
        ...
        internal class TransactionSigningContext
        {
            ...
            public SolarCoinTransactionBuilder Builder
            {
                get;
                set;
            }
        ...
        {
            public TransactionBuildingContext(SolarCoinTransactionBuilder builder)
            {
                Builder = builder;
                Transaction = (SolarCoinTransaction)builder._ConsensusFactory.CreateTransaction();
                AdditionalFees = Money.Zero;
            }
            public SolarCoinTransactionBuilder.BuilderGroup Group
            {
                get;
                set;
            }
        ...
        {
            SolarCoinTransactionBuilder _Parent;
            public BuilderGroup(SolarCoinTransactionBuilder parent)
            {
                _Parent = parent;
                FeeWeight = 1.0m;
        ...
        public SolarCoinTransactionBuilder()
        {
            _Rand = new Random();
        ...
        public SolarCoinTransactionBuilder(int seed)
        {
        ...
        /// <summary>
        /// If true, the SolarCoinTransactionBuilder will not select coins whose fee to spend is higher than its value. (Default: true)
        ...
        /// <summary>
        /// A callback used by the SolarCoinTransactionBuilder when it does not find the coin for an input
        /// </summary>
        ...
        /// <summary>
        /// A callback used by the SolarCoinTransactionBuilder when it does not find the key for a scriptPubKey
        /// </summary>
        ...
        LockTime? _LockTime;
        public SolarCoinTransactionBuilder SetLockTime(LockTime lockTime)
        {
            _LockTime = lockTime;
            return this;
        }
        ...
        public SolarCoinTransactionBuilder AddKeys(params ISecret[] keys)
        {
            AddKeys(keys.Select(k => k.PrivateKey).ToArray());
            return this;
        }

        public SolarCoinTransactionBuilder AddKeys(params Key[] keys)
        {
            _Keys.AddRange(keys);
        ...
        public SolarCoinTransactionBuilder AddKnownSignature(PubKey pubKey, TransactionSignature signature)
        {
            if (pubKey == null)
        ...
        public SolarCoinTransactionBuilder AddKnownSignature(PubKey pubKey, ECDSASignature signature)
        {
            if (pubKey == null)
                throw new ArgumentNullException(nameof(pubKey));
            if (signature == null)
        ...
        public SolarCoinTransactionBuilder AddCoins(params ICoin[] coins)
        {
            return AddCoins((IEnumerable<ICoin>)coins);
        }

        public SolarCoinTransactionBuilder AddCoins(IEnumerable<ICoin> coins)
        {
        ...
        /// <returns></returns>
        public SolarCoinTransactionBuilder SetGroupName(string groupName)
        {
        ...
        /// <returns></returns>
        public SolarCoinTransactionBuilder Send(IDestination destination, Money amount)
        {
        ...
        /// <param name="amount">The amount</param>
        /// <returns></returns>
        public SolarCoinTransactionBuilder Send(Script scriptPubKey, Money amount)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public SolarCoinTransactionBuilder SubtractFees()
        {
            if (_LastSendBuilder == null)
                throw new InvalidOperationException("No call to SolarCoinTransactionBuilder.Send has been done which can support the fees");
        ...
        public SolarCoinTransactionBuilder Send(IDestination destination, IMoney amount)
        {
            return Send(destination.ScriptPubKey, amount);
        }
        /// <summary>
        ...
        /// <returns></returns>
        /// <exception cref="System.NotSupportedException">The coin type is not supported</exception>
        public SolarCoinTransactionBuilder Send(Script scriptPubKey, IMoney amount)
        {
        ...
        /// <returns></returns>
        public SolarCoinTransactionBuilder SendAsset(IDestination destination, AssetMoney asset)
        {
        ...
        /// <param name="asset">The asset and amount</param>
        /// <returns></returns>
        public SolarCoinTransactionBuilder SendAsset(IDestination destination, AssetId assetId, ulong quantity)
        {
            return SendAsset(destination, new AssetMoney(assetId, quantity));
        }

        public SolarCoinTransactionBuilder Shuffle()
        {
        ...
        public SolarCoinTransactionBuilder SendAsset(Script scriptPubKey, AssetId assetId, ulong assetQuantity)
        {
            return SendAsset(scriptPubKey, new AssetMoney(assetId, assetQuantity));
        }

        public SolarCoinTransactionBuilder SendAsset(Script scriptPubKey, AssetMoney asset)
        {
            if (asset.Quantity < 0)
        ...
        public SolarCoinTransactionBuilder SetTransactionPolicy(StandardTransactionPolicy policy)
        {
        ...
        public SolarCoinTransactionBuilder Send(BitcoinStealthAddress address, Money amount, Key ephemKey = null)
        {
            if (amount < Money.Zero)
                throw new ArgumentOutOfRangeException("amount", "amount can't be negative");
        ...
        public SolarCoinTransactionBuilder IssueAsset(IDestination destination, AssetMoney asset)
        {
        ...
        public SolarCoinTransactionBuilder IssueAsset(Script scriptPubKey, AssetMoney asset)
        {
            AssertOpReturn("Colored Coin");
        ...
        public SolarCoinTransactionBuilder SendFees(Money fees)
        {
            if (fees == null)
        ...
        /// <returns></returns>
        public SolarCoinTransactionBuilder SendEstimatedFees(FeeRate feeRate)
        {
        ...
        /// <param name="feeRate"></param>
        /// <returns></returns>
        public SolarCoinTransactionBuilder SendEstimatedFeesSplit(FeeRate feeRate)
        {
            FilterUneconomicalCoinsRate = feeRate;
            var fee = EstimateFees(feeRate);
            SendFeesSplit(fee);
        ...
        /// <returns></returns>
        public SolarCoinTransactionBuilder SendFeesSplit(Money fees)
        {
            if (fees == null)
                throw new ArgumentNullException(nameof(fees));
        ...
        /// <returns></returns>
        public SolarCoinTransactionBuilder SetFeeWeight(decimal feeWeight)
        {
            CurrentGroup.FeeWeight = feeWeight;
            return this;
        }

        public SolarCoinTransactionBuilder SetChange(IDestination destination, ChangeType changeType = ChangeType.All)
        {
            return SetChange(destination.ScriptPubKey, changeType);
        }

        public SolarCoinTransactionBuilder SetChange(Script scriptPubKey, ChangeType changeType = ChangeType.All)
        {
        ...
        ConsensusFactory _ConsensusFactory = SolarCoinNetworks.Instance.Mainnet.Consensus.ConsensusFactory;
        public SolarCoinTransactionBuilder SetConsensusFactory(ConsensusFactory consensusFactory)
        {
            _ConsensusFactory = consensusFactory ?? SolarCoinNetworks.Instance.Mainnet.Consensus.ConsensusFactory;
            return this;
        }

        public SolarCoinTransactionBuilder SetConsensusFactory(Network network)
        {
            return SetConsensusFactory(network?.Consensus?.ConsensusFactory);
        }

        public SolarCoinTransactionBuilder SetCoinSelector(ICoinSelector selector)
        {
            if (selector == null)
        ...
        public SolarCoinTransaction BuildTransaction(bool sign)
        {
        ...
        /// <returns>The transaction</returns>
        /// <exception cref="NBitcoin.NotEnoughFundsException">Not enough funds are available</exception>
        public SolarCoinTransaction BuildTransaction(bool sign, SigHash sigHash)
        {
        ...
        {
            var scriptPubKey = coin.GetScriptCode();
            var keyRepo = new SolarCoinTransactionKeyRepository(this, ctx);
            var signer = new SolarCoinTransactionBuilderSigner(coin, ctx.SigHash, txIn);
        ...
        /// </summary>
        /// <returns></returns>
        public SolarCoinTransactionBuilder Then()
        {
            _CurrentGroup = null;
            return this;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SolarCoinTransactionBuilder Then(string groupName)
        {
        ...
        /// <returns></returns>
        public SolarCoinTransactionBuilder CoverOnly(Money amount)
        {
        ...
        SolarCoinTransaction _CompletedTransaction;
        ...
        /// <returns></returns>
        public SolarCoinTransactionBuilder ContinueToBuild(SolarCoinTransaction transaction)
        {
            if (_built)
                throw new InvalidOperationException("ContinueToBuild must be called with a new SolarCoinTransactionBuilder instance");
            if (_CompletedTransaction != null)
        ...
        /// </summary>
        /// <returns></returns>
        public SolarCoinTransactionBuilder CoverTheRest()
        {
            if (_CompletedTransaction == null)
        ...
        public SolarCoinTransactionBuilder AddKnownRedeems(params Script[] knownRedeems)
        {
